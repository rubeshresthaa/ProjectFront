...
const AddToCart = ({ product }) => {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      <div className="tracking-wide max-md:mx-auto">
        <div className="grid grid-cols-2 lg:flex-row bg-gray-100 rounded-lg shadow-md">
          ...
          <div className="flex gap-2">
            ...
            <h2 className="font-medium text-blue-gray-200 text-xl">{product.breeds}</h2>
          </div>
          <div className="mt-5">
